...
public class EssayProgressCircle extends View {
    ...
    public static final int DEFAULT_PAINT_WIDTH = 5;
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.EssayProgressCircle);
        mMaxSweepAngle = array.getInt(R.styleable.EssayProgressCircle_maxSweepAngle,DEFAULT_MAX_SWEEP_ANGLE);
        mMinSweepAngle = array.getInt(R.styleable.EssayProgressCircle_minSweepAngle,DEFAULT_MIN_SWEEP_ANGLE);
        mSweepSteps = array.getInt(R.styleable.EssayProgressCircle_sweepSteps,DEFAULT_SWEEP_STEPS);
        mCircleSteps = array.getInt(R.styleable.EssayProgressCircle_circleSteps, DEFAULT_CIRCLE_STEPS);
